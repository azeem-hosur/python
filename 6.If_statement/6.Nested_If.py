...
# Both approaches produce the same result. Use nested if statements 
# when the inner logic is complex or depends on the outer condition. Use and when both conditions are simple and equally important.
